...
public class AnonymousStats extends SettingsPreferenceFragment implements
    ...
    private static final String PREF_FILE_NAME = "REVOLTStats";
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mEnableReporting) {
            ...
            Uri uri = Uri.parse("http://revolt.iminisoft.org");
    ...
    public void onClick(DialogInterface dialog, int which) {
        if (which == DialogInterface.BUTTON_POSITIVE) {
            ...
            Uri uri = Uri.parse("http://revolt.iminisoft.org/revolt-statistics/");
            startActivity(new Intent(Intent.ACTION_VIEW, uri));
        }
    }
}
