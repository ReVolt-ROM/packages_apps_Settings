...
public class IncreasingRingPreference extends VolumePreference implements
    ...
    protected void onBindDialogView(View view) {
        ...
        mEnabledCheckbox.setChecked(Settings.REVOLT.getInt(cr, Settings.REVOLT.INCREASING_RING, 0) == 1);
        mMinVolumeSeekBar.setProgress(Settings.REVOLT.getInt(
                    cr, Settings.REVOLT.INCREASING_RING_MIN_VOLUME, 1));
        int interval = Settings.REVOLT.getInt(cr, Settings.REVOLT.INCREASING_RING_INTERVAL, 0);
        int index = 0;
    ...
    protected void onDialogClosed(boolean positiveResult) {
        ...
        if (positiveResult) {
            ...
            Settings.REVOLT.putInt(cr, Settings.REVOLT.INCREASING_RING, checked ? 1 : 0);
            Settings.REVOLT.putInt(cr, Settings.REVOLT.INCREASING_RING_INTERVAL,
                    mIntervalValues[mInterval.getSelectedItemPosition()]);
            Settings.REVOLT.putInt(cr,
                    Settings.REVOLT.INCREASING_RING_MIN_VOLUME,
