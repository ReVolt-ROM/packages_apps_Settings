...
public class AutoBrightnessCustomizeDialog extends AlertDialog
    ...
    private void updateSettings(boolean forceDefault) {
        ...
        if (!forceDefault) {
            lux = fetchItems(Settings.REVOLT.AUTO_BRIGHTNESS_LUX);
            values = fetchItems(Settings.REVOLT.AUTO_BRIGHTNESS_BACKLIGHT);
        }
    ...
    private void putSettings() {
        ...
        putItems(Settings.REVOLT.AUTO_BRIGHTNESS_LUX, lux);
        putItems(Settings.REVOLT.AUTO_BRIGHTNESS_BACKLIGHT, values);
    }

    private int[] fetchItems(String setting) {
        String value = Settings.REVOLT.getString(getContext().getContentResolver(), setting);
        if (value != null) {
    ...
    private void putItems(String setting, int[] values) {
        ...
        Settings.REVOLT.putString(getContext().getContentResolver(), setting, value);
    }
