...
public class AutoBrightnessSetup extends AlertActivity implements
    ...
    protected void onStart() {
        ...
        float currentSensitivity = Settings.REVOLT.getFloat(resolver,
        ...
        mTwilightAdjustment.setChecked(Settings.REVOLT.getInt(resolver,
                Settings.REVOLT.AUTO_BRIGHTNESS_TWILIGHT_ADJUSTMENT, 0) != 0);
    }
    ...
    public void onClick(DialogInterface dialog, int which) {
        ...
        if (selection >= 0) {
            ...
            Settings.REVOLT.putFloat(resolver,
                    Settings.REVOLT.AUTO_BRIGHTNESS_RESPONSIVENESS, sensitivity);
        }
        ...
        Settings.REVOLT.putInt(resolver,
                Settings.REVOLT.AUTO_BRIGHTNESS_TWILIGHT_ADJUSTMENT,
